			...
			<div id="login_other">
				...
				<script type="text/javascript">
					var naver_id_login = new naver_id_login("ac6ZedX0lErobHrFaU_k",
															"https://www.carrotvillage.kro.kr/CarrotVillage/main/naverLogin");  // Client ID, CallBack URL 삽입
																											  // 단 'localhost'가 포함된 CallBack URL
					var state = naver_id_login.getUniqState();

					naver_id_login.setButton("green", 3, 40);
					naver_id_login.setDomain("https://www.carrotvillage.kro.kr/CarrotVillage/main/login");	//  URL
