...
<script type="text/javascript">
		var naver_id_login = new naver_id_login("ac6ZedX0lErobHrFaU_k", "https://www.carrotvillage.kro.kr/CarrotVillage/main/naverLogin"); // 역시 마찬가지로 'localhost'가 포함된 CallBack URL
